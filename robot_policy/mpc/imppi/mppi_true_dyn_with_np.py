...
class MPPI:
    """
    MPPI according to algorithm 2 in Williams et al., 2017
    'Information Theoretic MPC for Model-Based Reinforcement Learning'
    This implementation doesn't learn dynamics, instead, it uses the true dynamics and reward function in the simulator.
    It shows how to update the control sequence.
    """
